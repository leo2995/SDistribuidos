class DropBoxController {
    ...
    constructor() {
        this.selectionchange = new Event('selectionchange');
        this.currentFolder = ['variados'];
    ...
    connectFirebase() {
        ...
        var config = {
            apiKey: "AIzaSyA6PfZwtrtZkigha1Y7GgciS91dcSHgEYg",
            authDomain: "lvboxback.firebaseapp.com",
            databaseURL: "https://lvboxback.firebaseio.com",
            projectId: "lvboxback",
            storageBucket: "lvboxback.appspot.com",
            messagingSenderId: "953207695342"
        };
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                ...
                responses.forEach(resp => {
                    let url = `/${encodeURIComponent(resp.fullPath || resp.name)}?alt=media`;
    ...
    renderNav() {
        ...
        for (let index = 0; index < this.currentFolder.length; index++) {
            ...
            const folderName = this.currentFolder[index];
    ...
    initEventsLi(li) {
        ...
        li.addEventListener('dblclick', e => {
            ...
            switch (file.type) {
                ...
                default:
                    window.open('https://firebasestorage.googleapis.com/v0/b/lvboxback.appspot.com/o' + file.path)
            }
        })
        ...
        li.addEventListener('click', e => {
            ...
            if (e.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    this.listFilesEl.dispatchEvent(this.selectionchange);
